...
RUN \
    ...
    curl -sL https://www.terraria.org/system/dedicated_servers/archives/000/000/037/original/terraria-server-$VANILLA_VERSION.zip --output /tmp/terraria-server.zip && \
